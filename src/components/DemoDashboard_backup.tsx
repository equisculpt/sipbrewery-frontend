        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <div className="inline-flex items-center justify-center gap-2 rounded-full px-3 py-1  text-green-200 text-sm tabular-nums">
                <span className="text-green-400">+₹{totalProfit.toLocaleString()}</span>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <motion.div 
              ...
              tabIndex={0}
              aria-label={`Portfolio Growth, value ₹${currentPortfolioValue.toLocaleString()}, profit ₹${totalProfit.toLocaleString()}, XIRR ${currentXIRR}%`}
            >
                          ...
                          return [
                            <div style={{ color: '#ffffff' }}>
                              ...
                              <div style={{ color: '#fbbf24', fontSize: '12px' }}>
                                Invested: ₹{props.payload.totalInvested.toLocaleString()}
                              </div>
                              <div style={{ color: '#10b981', fontSize: '12px' }}>
                                Profit: ₹{props.payload.profit.toLocaleString()}
                              </div>
                            </div>, 
                            ''
                          ];
            ...
            <motion.div 
              ...
              whileHover={{ scale: 1.02, y: -5 }}
              tabIndex={0}
              aria-label={`Investment Allocation pie, total invested ₹${currentPortfolioValue.toLocaleString()}`}
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-purple-200">
                        {item.value}% • ₹{(item.amount/1000).toFixed(0)}K
                      </div>
                    </div>
                  </div>
                ))}
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-purple-300 text-sm">Real-time insights • Updated {new Date().toLocaleTimeString()}</p>
              </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mb-12">
              ...
              <motion.div 
                ...
                tabIndex={0}
                aria-label={`Principal ₹${(totalInvested/1000).toFixed(0)}K, Invested`}
              >
              ...
              <motion.div 
                ...
                transition={{ duration: 0.6, delay: 0.2 }}
                tabIndex={0}
                aria-label={`Daily P&L +₹2.45K, up 1.48%`}
              >
              ...
              <motion.div 
                ...
                tabIndex={0}
                aria-label={`Total Gains ₹${(totalProfit/1000).toFixed(0)}K, +${absoluteGrowth.toFixed(1)}%`}
              >
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <p className="text-white text-base leading-relaxed">
                        🚀 <strong className="text-yellow-300 font-semibold">Market Rally Continues:</strong> Nifty 50 surged 1.2% today driven by strong IT sector performance. 
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    ...
                    <div className="flex items-center justify-between text-sm gap-2">
                      <span className="text-purple-300 truncate">₹10,000 • Next: Jan 15, 2024</span>
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    ...
                    <div className="flex items-center justify-between text-sm gap-2">
                      <span className="text-purple-300 truncate">₹25,000 • Jan 8, 2024</span>
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    ...
                    <div className="flex items-center justify-between text-sm gap-2">
                      <span className="text-purple-300 truncate">₹15,000 • Jan 7, 2024</span>
                ...
                <div className="mt-6 pt-4 border-t border-white/10">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-white font-semibold">Total: ₹50,000</span>
                  </div>
                </div>
              </div>
              </motion.div>
            ...
            <div role="dialog" aria-modal="true" aria-label="New SIP" className="fixed inset-0 z-50 flex items-center justify-center">
              ...
              <div ref={sipModalRef} className="relative z-10 w-full max-w-lg mx-4 rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-white/15 ring-1 ring-white/10 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={()=>setShowNewSIP(false)} className="text-purple-200 hover:text-white">✕</button>
                </div>
            ...
            <div role="dialog" aria-modal="true" aria-label="New Lumpsum" className="fixed inset-0 z-50 flex items-center justify-center">
              ...
              <div ref={lumpsumModalRef} className="relative z-10 w-full max-w-lg mx-4 rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-white/15 ring-1 ring-white/10 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={()=>setShowNewLumpsum(false)} className="text-purple-200 hover:text-white">✕</button>
                </div>
                <div className="grid gap-4">
                  <label className="text-sm text-purple-200">Amount (₹)
            ...
            <div role="dialog" aria-modal="true" aria-label="Report" className="fixed inset-0 z-50 flex items-center justify-center">
              ...
              <div ref={reportModalRef} className="relative z-10 w-full max-w-2xl mx-4 rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-white/15 ring-1 ring-white/10 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={()=>setShowReportModal(null)} className="text-purple-200 hover:text-white">✕</button>
                </div>
          ...
          >
            ...
            <div className="grid lg:grid-cols-3 gap-4">
              <div className="p-6">
                ...
                <div className="mt-3 text-sm text-purple-200">Regret saved: <span className="text-emerald-300 font-semibold">₹{(totalProfit*0.18).toLocaleString()}</span></div>
              </div>
              <div className="p-6">
              ...
              <div className="p-6">
                ...
                <ul className="text-sm text-purple-200 space-y-2">
                  <li>• Rebalance 3 funds to target weights</li>
                  <li>• Shift ₹3,000 SIP from overlapping schemes</li>
                  <li>• Tax-harvest ELSS lot expiring next month</li>
                </ul>
          ...
          <motion.div id="panel-risk" role="tabpanel" aria-labelledby="tab-risk" className="mb-12" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.7 }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Institutional‑grade Risk Lens</h2>
          ...
          <motion.div id="panel-goals" role="tabpanel" aria-labelledby="tab-goals" className="mb-12" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.7 }}>
            ...
            <div className="grid lg:grid-cols-3 gap-4">
              ...
              <div className="p-6">
                ...
                <ul className="text-sm text-purple-200 space-y-2">
                  <li>• Increase SIP by 10% to reach goal 4 months sooner</li>
                  <li>• Rebalance equity tilt -1 to lower drawdown risk</li>
                  <li>• Enable auto-tax-harvest in Q4</li>
                </ul>
